...
// *** If you add any prop_columns here, document it in the client. ***

// Not every field needs to be searchable. Most of the IPHON source stuff (e.g. volume, number) isn't.
...
if (!!(+process.env.IS_IPHON)) {
    var PROP_COLUMNS = {
        'inventory_id':     'doculects'
    ,   'language_name':    'doculects'
    ,   'glottocode':       'doculects'
    ,   'dialect':          'doculects'
    ,   'dialect_name':     'doculects'
    ,   'source_bibkey':    'doculects'
    ,   'source_url':       'doculects'
    ,   'source_doi':       'doculects'
    ,   'name':             'languages'
    ,   'iso6393':          'languages'
    ,   'family':           'languages'
    ,   'genus':            'languages'
